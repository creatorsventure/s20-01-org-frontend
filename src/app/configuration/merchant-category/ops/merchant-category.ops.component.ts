...
@Component({selector: 'app-merchantCategory-ops', templateUrl: './merchant-category.ops.component.html', styles: [], standalone: false})
export class MerchantCategoryOpsComponent extends OpsAbstract implements OnInit {
