...
@Component({selector: 'app-scheme-ops', templateUrl: './scheme.ops.component.html', styles: [], standalone: false})
export class SchemeOpsComponent extends OpsAbstract implements OnInit {
