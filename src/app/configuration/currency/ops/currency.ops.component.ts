...
@Component({selector: 'app-currency-ops', templateUrl: './currency.ops.component.html', styles: [], standalone: false})
export class CurrencyOpsComponent extends OpsAbstract implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.crudForm = this.fb.group({
            symbol: this.appCtrlService.generateFormControl(CONTROL_DESCRIPTION.currency, this.object?.symbol),
            decimalPlaces: this.appCtrlService.generateFormControl(CONTROL_DESCRIPTION.numeric, this.object?.decimalPlaces),
        });
    }
